            ...
            if (validarCadenas(apellidos) || apellidos === "") {
                if (password === confirm) {
                    try {
                        ...
                        await axios.put('http://api-haed.danielreyesepitacio.cloud/api/users/update', updatedParams,
                            {
                                headers: {
                                    'Authorization': `Bearer ${token}`,
                                    'Content-Type': 'application/json'
                        ...
                        <div className="col-lg-8">
                            <div className="card z-depth-3">
                                ...
                                <div className="card-body">
                                    ...
                                    <ul id="nav-card" className="nav nav-pills nav-pills-success nav-justified">
                                        <li className="nav-item">
                                            <a data-target="#edit" data-toggle="pill" className="nav-link active show "><i className="icon-note"></i> <span className="hidden-xs">Editar Perfil</span></a>
                                        </li>
                                    </ul>
                                        ...
                                        (
                                            <ul id="nav-card" className="nav nav-pills nav-pills-success nav-justified">
                                                ...
                                                <li className="nav-item">
                                                    ...
                                                    <a data-target="#edit" data-toggle="pill" className="nav-link  show ">
                                                        <i className="icon-note"></i>
                                                        <span className="hidden-xs">Actualizando credenciales</span>
                                                        <div>
                                        ...
                                        (
                                            ...
                                            <ul id="nav-card" className="nav nav-pills nav-pills-success nav-justified">
                                                ...
                                                <li className="nav-item">
                                                    <a data-target="#edit" data-toggle="pill" className="nav-link  show ">
                                                        <i className="icon-note"></i>
                                                        <span id='error' className="hidden-xs">{error}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <div className="tab-pane active  show" id="edit">
                                            ...
                                            <form onSubmit={handleUpdate}>
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-lg-3 col-form-label form-control-label">Numero ID</label>
                                                    <div className="col-lg-9">
                                                        <input className="form-control" type="text" onChange={(e => setMat(e.target.value))} />
                                                    </div>
                                                </div>
                                                {/* Separador de input  */}
                                                <div className="form-group row">
                                                    <label className="col-lg-3 col-form-label form-control-label">Nombre(s)</label>
                                                    <div className="col-lg-9">
                                                        <input className="form-control" type="text" onChange={(e => setNombres(e.target.value))} />
                                                    </div>
                                                </div>
                                                {/* Separador de input  */}
                                                <div className="form-group row">
                                                    <label className="col-lg-3 col-form-label form-control-label">Apellido(s)</label>
                                                    <div className="col-lg-9">
                                                        <input className="form-control" type="text" onChange={(e) => setApellidos(e.target.value)} />
                                                    </div>
                                                </div>
                                                {/* Separador de input  */}
                                                <div className="form-group row">
                                                    <label className="col-lg-3 col-form-label form-control-label">Correo Electronico</label>
                                                    <div className="col-lg-9">
                                                ...
                                                {/* Separador de input  */}
                                                <div className="form-group row">
                                                    <label className="col-lg-3 col-form-label form-control-label">Contraseña nueva</label>
                                                    <div className="col-lg-9">
                                                        <input id="myPassword" className="form-control" type="password" onChange={(e) => setPass(e.target.value)} />
                                                    </div>
                                                </div>
                                                {/* Separador de input  */}
                                                <div className="form-group row">
                                                    <label className="col-lg-3 col-form-label form-control-label">Confirmar contraseña</label>
                                                    <div className="col-lg-9">
                                                        <input id="myPassword2" className="form-control" type="password" onChange={(e) => setConfirm(e.target.value)} />
                                                ...
                                                <div className="form-group row">
                                                    ...
                                                    <div className="col-lg-9">
                                                        <input type="reset" className="btn btn-secondary" onClick={reload} value="Cancelar" />
